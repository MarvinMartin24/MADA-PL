    ...
    def __init__(self, cfg, mode, dataModule=None):
        ...
        if mode == 'Train':
            ...
            for class_idx in self.classes:
                self.train_accuracy_domain[f"train_accuracy_domain_src_{class_idx}"] = pl.metrics.Accuracy()
                self.train_accuracy_domain[f"train_accuracy_domain_tgt_{class_idx}"] = pl.metrics.Accuracy()
